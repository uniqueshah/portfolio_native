...
const skills = [
  ...
  { name: "TypeScript", level: 50, color: "from-blue-500 to-blue-700" },
  { name: "Next.js", level: 50, color: "from-green-400 to-green-600" },
  ...
  { name: "SQL", level: 78, color: "from-blue-500 to-indigo-600" },
];
